...
router.get('/steal', function(req, res) {
	var sql='SELECT * from players_23 WHERE keeper=\'no\' and owner!=\'available\' and owner!=\'Kyle Stephan\' and owner!=\'Kevin Pulsifer\' and owner!=\'Zack Omalley\' and owner!=\'Kevin McClure\' and owner!=\'Shawn Plesnick\' and owner!=\'Adam Staryak\' ORDER by players_23.rank';
	db.query(sql,function (err, data){
		if (err) throw err;
